...
public class AcademPerfomanceServiceTest {
	...
	public final void testFindByStudentAndSubjectAndDate() {
		...
		final AcademPerfomance actual = academPerfomanceService.findBy(student, subject, date);
	...
	public final void testCountAverageMarkByStudentAndSubject() {
		...
		final AcademPerfomance academPerfomanceWithNullId3 = createAcadPerfomanceWithNullId(1,
				"Dave", "Joro", 1,
