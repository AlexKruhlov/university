...
public class JsonConverterTest {
	...
	// "test/resources/ua/rafael/util/progress.json";
	// private Student student;
	//
	// @Before
	// public final void startUp() {
	// final List<Mark> markList = new ArrayList<>();
	// markList.add(new Mark(LocalDate.of(2017, 07, 27), new Subject(1,
	// "Mathematics"), 4));
	// markList.add(new Mark(LocalDate.of(2017, 07, 27), new Subject(2, "History"),
	// 4));
	// markList.add(new Mark(LocalDate.of(2017, 07, 27), new Subject(3,
	// "Chemistry"), 4));
	// markList.add(new Mark(LocalDate.of(2017, 07, 27), new Subject(4,
	// "Mathematics"), 4));
	// markList.add(new Mark(LocalDate.of(2017, 07, 27), new Subject(5, "English"),
	// 4));
	// markList.add(new Mark(LocalDate.of(2017, 07, 27), new Subject(6,
	// "Mathematics"), 4));
	...
	// toJson("progress.json", student);
	// final String expected = readAllFromFile(filePath);
	// final String actual = readAllFromFile("progress.json");
	// assertEquals("Strings should be the same in value", expected, actual);
	// }
	//
	// @Test
	...
	// toJson("progress.json", student);
	// final Student actual = fromJson("progress.json");
	// assertEquals("Object should be the same in value", student.toString(),
	// actual.toString());
	// }
	//
	// @Test(expected = FileNotFoundException.class)
	// public final void testFromJson_fileNotFound() throws FileNotFoundException,
	// IOException {
